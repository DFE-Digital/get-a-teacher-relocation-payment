...
module Applicants
  class PersonalDetail
    ...
    validates :passport_number, presence: true, length: { maximum: 20, message: "passport number is invalid" }
