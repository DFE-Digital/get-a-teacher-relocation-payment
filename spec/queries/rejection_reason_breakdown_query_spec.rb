  ...
  describe "#call" do
    context "when there are a few application progresses with rejection reasons" do
      before do
        ...
        create(:application_progress, application: create(:application, applicant:), rejection_reason: "duplicate_submission") # This one should not be included in the count because the associated application is not submitted
      end
